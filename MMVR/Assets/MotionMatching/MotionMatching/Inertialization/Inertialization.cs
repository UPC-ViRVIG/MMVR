...
namespace MotionMatching
{
    ...
    public class Inertialization
    {
        ...
        /// </summary>
        public void PoseTransition(PoseSet sourcePoseSet, PoseSet targetPoseSet, int sourcePoseIndex, int targetPoseIndex)
        {
            sourcePoseSet.GetPose(sourcePoseIndex, out PoseVector sourcePose);
            targetPoseSet.GetPose(targetPoseIndex, out PoseVector targetPose);
